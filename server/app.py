...
# Archivo de datos
DATA_FILE = "view_counter_data.json"

def load_data():
    """Carga los datos de visitas"""
...
def view_counter():
    """Genera el SVG dinámicamente y cuenta la visita"""
  ...
  <text x="50" y="334" font-family="monospace" font-size="11" fill="#4d4d4d" text-anchor="end">{min_y_label}</text>
...
def index():
    ...
    return f'''
    <html>
        <head><title>View Counter</title></head>
        <body style="font-family: Arial; text-align: center; padding: 50px;">
            <h1>Profile View Counter</h1>
            <p>Total Views: {data["total_views"]}</p>
            <img src="/view-counter.svg" alt="View Counter">
            <br><br>
            <p>Add this to your GitHub README:</p>
            <code>![Profile Views](https://tu-servidor.com/view-counter.svg)</code>
        </body>
    </html>
    '''
